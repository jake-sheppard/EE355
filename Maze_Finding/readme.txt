EE 355 Programming Assignment 3, A Mazeing BFS

Name: Jake Sheppard

Email Address: jwsheppa@usc.edu
...
: Piazza Forum was helpful and defineately using gdb to debug the code.
=============================== Prelab ==================================
...
: First check to see if the maze cell is not a #, and the visit cell is not 
1. The you can add location to Queue and mark the cell as visited.
...
: My maze has multiple routes. The longest route would be to go all the way
down to the final row, then make its way back up. The shortest path goes 
down to the third row then comes up.
